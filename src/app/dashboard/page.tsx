...
const quickAccess = [
  ...
  {
    icon: <GearIcon />,
    chip: "bg-zinc-100 text-zinc-500 dark:bg-zinc-500/15 dark:text-zinc-400",
    label: "Настройки",
  },
];

const navItems = [
  { icon: <HomeIcon />, label: "Главная", href: "/dashboard", active: true },
  { icon: <DumbbellIcon />, label: "Тренажёры", href: "/coming-soon", active: false },
  { icon: <ChartIcon />, label: "Прогресс", href: "/coming-soon", active: false },
  { icon: <UserIcon />, label: "Профиль", href: "/coming-soon", active: false },
];
    ...
    <main className="flex-1 bg-white">
      <div className="mx-auto w-full max-w-md px-5 pt-8 pb-28">
        ...
        <div className="flex items-start justify-between gap-3">
          <div>
            <h1 className="text-3xl font-bold tracking-tight">Irregular Verbs</h1>
        ...
        <section className="mt-5 flex items-center overflow-hidden rounded-3xl border border-line/60 bg-gradient-to-r from-white to-blue-100">
          <div className="min-w-0 flex-1 p-6">
            <h2 className="text-2xl font-bold tracking-tight">Привет, {firstName}!</h2>
            <p className="mt-2 text-subtle">Отличная работа! Продолжай в том же духе.</p>
          </div>
        ...
        <section className="mt-4 rounded-3xl border border-line/60 bg-white p-4">
          <ul className="grid grid-cols-4 divide-x divide-line/60">
            ...
            <li className="flex flex-col items-center gap-1.5 px-1 text-center">
              <span className="flex size-11 items-center justify-center rounded-2xl bg-violet-100 text-violet-600 dark:bg-violet-500/15 dark:text-violet-400">
                <ChartIcon />
              </span>
              <span className="text-[11px] text-subtle">Уровень</span>
              <span className="text-2xl leading-none font-bold text-violet-600 dark:text-violet-400">
                B1
              </span>
              <span className="text-[11px] leading-tight text-subtle">Средний</span>
            </li>
          </ul>
        </section>
        ...
        <section className="mt-4 rounded-3xl bg-gradient-to-br from-blue-500 to-blue-700 p-6 text-white">
          <div className="flex items-start justify-between gap-4">
            <div>
              ...
              <p className="mt-1 text-sm text-blue-100">Текущий тренажёр</p>
            </div>
          ...
          <div className="mt-4 flex items-center gap-4">
            ...
            <div className="min-w-0">
              <p className="text-lg font-bold">Три формы глаголов</p>
              <p className="text-sm text-blue-100">Артефакт-карточки</p>
            </div>
          </div>
        ...
        <section className="mt-4 rounded-3xl border border-line/60 bg-white p-6">
          <div className="flex items-center justify-between gap-3">
            ...
            <Link
              href="/coming-soon"
              className="flex items-center gap-1.5 rounded-full bg-blue-50 px-3.5 py-2 text-sm font-medium text-blue-600 transition-colors hover:bg-blue-100 dark:bg-blue-500/15 dark:text-blue-400 dark:hover:bg-blue-500/25"
            >
              <TargetSmallIcon />
              Изменить цель
            </Link>
          </div>
          <p className="mt-1 text-sm text-subtle">Ежедневная цель</p>

          <div className="mt-4 flex items-center gap-4">
            <div className="min-w-0 flex-1">
              <p className="text-lg">
                <span className="text-3xl font-bold text-blue-600 dark:text-blue-400">12</span>
                <span className="text-subtle"> / 20</span>
              </p>
              <p className="text-sm text-subtle">глаголов</p>
              ...
              <p className="mt-2 text-sm text-subtle">
                Ещё <span className="font-semibold text-foreground">8</span> глаголов до цели
              </p>
            </div>
            <TargetIcon />
          </div>
        ...
        {/* быстрый доступ */}
        <h2 className="mt-7 text-xl font-bold">Быстрый доступ</h2>
  ...
  return (
    <svg width="22" height="22" viewBox="0 0 24 24" fill="none" aria-hidden>
      <path
        ...
        opacity="0.9"
      />
      <circle cx="12" cy="12" r="3.4" fill="#fff" className="dark:fill-zinc-900" />
    </svg>
  );
}
